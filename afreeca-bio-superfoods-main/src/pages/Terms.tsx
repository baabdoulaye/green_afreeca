        ...
        <Card className="p-8 space-y-8 animate-fade-in">
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              ventes de produits proposés par Green Afreeca, situé à
              Saint-Denis, France. Toute commande implique l'acceptation sans
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-4">
              Tous nos produits sont certifiés bio, sans additifs artificiels,
              et proviennent de nos champs au Sénégal dans le respect du
              commerce équitable.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Les commandes peuvent être passées directement sur notre site web.
              Chaque commande fait l'objet d'une confirmation par email. Nous
              nous réservons le droit d'annuler toute commande en cas de force
              majeure, de rupture de stock ou de problème de paiement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Les prix sont indiqués en euros (€) TTC. Nous acceptons les
              paiements par carte bancaire et autres moyens de paiement
              sécurisés. Les prix peuvent être modifiés sans préavis, mais les
              commandes sont facturées au prix en vigueur au moment de la
              validation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Les délais de livraison sont de 3 à 5 jours ouvrés en France
              métropolitaine.
              <strong className="text-primary">
                {" "}
                La livraison est gratuite pour toute commande supérieure à 30€.
              </strong>{" "}
              Pour les montants inférieurs, des frais de livraison de 4,99€
              s'appliquent.
            </p>
            <p className="text-muted-foreground">
              Nous livrons uniquement en France métropolitaine pour le moment.
              Les livraisons internationales seront disponibles prochainement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              de 14 jours à compter de la réception de votre commande pour
              exercer votre droit de rétractation sans avoir à justifier de
              motif.
            </p>
            <p className="text-muted-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              défectueux ou non conforme, nous procéderons à un échange ou un
              remboursement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              au RGPD. Elles sont utilisées uniquement pour le traitement de
              votre commande et ne seront jamais transmises à des tiers sans
              votre consentement.
            </p>
            <p className="text-muted-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              propriété exclusive de Green Afreeca et sont protégés par les lois
              sur la propriété intellectuelle. Toute reproduction sans
          ...
          <section>
            ...
            <ul className="list-none text-muted-foreground space-y-2 ml-4 mt-4">
              ...
              <li>
                <strong>Adresse :</strong> 4 rue Bobby Sands - 93200
                Saint-Denis, France 🇫🇷
              </li>
              <li>
                <strong>SIRET :</strong> 984 086 520 00017
