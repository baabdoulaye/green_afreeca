      ...
      <Card className="p-8 space-y-6">
        ...
        <section>
          <p className="text-muted-foreground mb-4">
            Green Afreeca s'engage à protéger la vie privée de ses utilisateurs. Cette politique de 
        ...
        {/* Données collectées */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">1. Données collectées 📋</h2>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            ...
            <li>Informations de paiement : données de transaction (via Stripe sécurisé)</li>
            <li>Données de navigation : cookies, adresse IP, historique de navigation sur le site</li>
          </ul>
        </section>

        {/* Utilisation des données */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">2. Utilisation des données 🎯</h2>
          <p className="text-muted-foreground mb-3">
        ...
        {/* Base légale */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">3. Base légale du traitement ⚖️</h2>
          <p className="text-muted-foreground mb-3">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            ...
            <li>Notre intérêt légitime (amélioration du service, lutte contre la fraude)</li>
          </ul>
        </section>

        {/* Conservation des données */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">4. Conservation des données 📅</h2>
          <p className="text-muted-foreground">
            Vos données sont conservées pendant la durée nécessaire aux finalités pour lesquelles elles sont 
            collectées, conformément aux obligations légales en vigueur. Les données de facturation sont 
            conservées 10 ans, les données de compte client 3 ans après la dernière activité.
          </p>
        </section>

        {/* Partage des données */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">5. Partage des données 🤝</h2>
          <p className="text-muted-foreground mb-3">
        ...
        {/* Sécurité */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">6. Sécurité des données 🛡️</h2>
          <p className="text-muted-foreground">
            Nous mettons en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos 
            données contre tout accès non autorisé, perte, destruction ou divulgation. Les paiements sont 
        ...
        {/* Réclamation */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-3">9. Réclamation 📣</h2>
          <p className="text-muted-foreground">
